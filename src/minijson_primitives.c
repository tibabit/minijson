...
JSON_PRIMITIVE_NEW_DEFINITION(uint, 	unsigned int)
JSON_PRIMITIVE_NEW_DEFINITION(short, 	short)
JSON_PRIMITIVE_NEW_DEFINITION(ushort, 	unsigned short)
JSON_PRIMITIVE_NEW_DEFINITION(long, 	long)
JSON_PRIMITIVE_NEW_DEFINITION(ulong, 	unsigned long)
...
JSON_PRIMITIVE_GET_DEFINITION(uint, 	unsigned int)
JSON_PRIMITIVE_GET_DEFINITION(short, 	short)
JSON_PRIMITIVE_GET_DEFINITION(ushort, 	unsigned short)
JSON_PRIMITIVE_GET_DEFINITION(long, 	long)
JSON_PRIMITIVE_GET_DEFINITION(ulong, 	unsigned long)
...
JSON_PRIMITIVE_SET_DEFINITION(uint, 	unsigned int)
JSON_PRIMITIVE_SET_DEFINITION(short, 	short)
JSON_PRIMITIVE_SET_DEFINITION(ushort, 	unsigned short)
JSON_PRIMITIVE_SET_DEFINITION(long, 	long)
JSON_PRIMITIVE_SET_DEFINITION(ulong, 	unsigned long)
